...
<html>
	...
	<title>Mão na roda - Reporte um erro</title>
	...
	<script> 
			function validar(){
				...
				if(document.getElementById("titulo").value == "" || document.getElementById("titulo").value.indexOf('@') ==-1 || document.getElementById("titulo").value.indexOf('.') ==-1){
					...
					alert('Por favor, digite o erro encontrado');
				...
				<div class="container">
					<div class="pm-body clearfix">
                            <ul class="tab-nav tn-justified">
                                <li class="active"><a href="">Reportar um erro </a></li>
                            </ul>
                            <br><br><br><br><br><br><br><form name='form' action='/MaoNaRoda/contato' method='post'>
                            <input type='hidden' name='acao' value='enviaerro'>
                            <div class="pmb-block">
                                <div class="pmbb-header">
                                    <h2><i class="zmdi zmdi-format-size"></i> Deixe seu e-mail</h2>
                                </div>
                                 <div class="">
                                    <div class="">
                            ...
                            <div class="">
                                <div class="pmbb-header">
                                    <h2><i class="zmdi zmdi-view-list-alt"></i> Descreva o erro</h2>
                                </div>
                                <div class="">
                                    <textarea placeholder="Descreva o erro" rows="10" name='erro' id='descricao' cols="80" style="resize:none;"></textarea>
                                </div><br>
                                <div class="m-t-30">
