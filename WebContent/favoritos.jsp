...
<html>
    <head>
        ...
        <title>Mão na roda - Favoritos</title>
        ...
        <section id="main">
            ...
            <ul class="main-menu">
			 ...
			 <section id="content">
                ...
                <c:forEach items="${favorito}" var="favorito">
				...
				<a href='/MaoNaRoda/pesquisa/${oferta.id}'><div class="list-group-item media">
                                ...
                                <div class="pull-right">
                                    <div class="actions dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li>
                                                <a href="/MaoNaRoda/adicionar?acao=removerfavorito&id=${favorito.id}">Deletar</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <center>Você não possui favorito</center>
                            </c:if>
             </div>       
            </section>
        </section>
