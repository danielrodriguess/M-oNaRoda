...
<html>
    <head>
        ...
        <title>Mão na roda - Cadastro de ofertas</title>
                ...
                <div class="container container-alt">
                       <div class="pm-body clearfix">
                            ...
                            <div class="">
                                ...
                                <div class="">
                                    <textarea placeholder="Descrição" rows="10" name='descricao' id='descricao' cols="80" style="resize:none;"></textarea>
                                </div><br>
                                                                <div class="pmbb-header">
                                <h2><i class="zmdi zmdi-brightness-4"></i> Turno</h2>
                                </div>
							<input type="checkbox" name="manha" value="sim" id='manha'>Manhã
